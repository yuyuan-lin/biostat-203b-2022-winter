...
`who am i` is supposed to return the invoker's real user name.
...
`history` command displays all the commands executed. Piping this command to `tail` will display the last 10 commands excuted in shell.
